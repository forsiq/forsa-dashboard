...
export const Dropdown: React.FC<DropdownProps> = ({ 
  ...
  return (
    <div className={cn("relative inline-block w-full sm:w-48", className)} ref={dropdownRef}>
      {label && (
      ...
      <button
        ...
        className={cn(
          "w-full flex items-center justify-between gap-2 px-3 py-2.5 bg-obsidian-outer border border-white/5 rounded-sm h-[40px]",
        ...
        >
          {options.map((option) => (
            <button
              ...
              className={cn(
                "w-full flex items-center justify-between px-3 py-2.5 text-[10px] font-black uppercase tracking-widest text-start transition-colors",
                value === option.value 
