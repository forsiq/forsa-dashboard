...
/**
 * Logo Component - Obsidian Edition
 * 
 * This component renders the ZoneVast brand identity as an inline SVG.
 * By inlining the SVG, we ensure zero-latency loading and eliminate path resolution
 * issues common in distributed or hash-routed environments.
 */
