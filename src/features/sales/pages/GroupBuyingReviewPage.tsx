            ...
            <div className={cn(
                ...
                <div className="flex flex-wrap gap-3">
                    <div className="bg-obsidian-card p-3 px-6 rounded-2xl border border-border flex items-center gap-6 shadow-xl">
                        <div>
                            <span className="text-[10px] font-black text-zinc-muted uppercase block tracking-widest leading-none">Awaiting Finalization</span>
                        ...
                        <div>
                            <span className="text-[10px] font-black text-zinc-muted uppercase block tracking-widest leading-none">Active Matrix Reach</span>
            ...
            {isLoading ? (
                ...
                <Card className="!p-32 text-center space-y-6 bg-obsidian-card/40 border-dashed border-border/40">
                    ...
                    <div className="max-w-md mx-auto space-y-2">
                        <h3 className="text-xl font-black text-zinc-text uppercase tracking-widest">All Nodes Synchronized</h3>
                            ...
                            >
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="space-y-1">
                                            <span className="text-[10px] font-black text-brand uppercase tracking-[0.3em] leading-none">{campaign.category?.name || 'ASSET PROTOCOL'}</span>
                                    ...
                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between">
                                                <span className="text-[10px] font-black text-zinc-muted uppercase tracking-widest">Activation Threshold</span>
                                                <span className={cn(
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                             ...
                                             <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 space-y-1">
                                                 <span className="text-[10px] font-black text-zinc-muted uppercase tracking-widest">Temporal Window</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-brand">
                            ...
                            <h4 className="text-xs font-black uppercase tracking-[0.2em]">Orchestration Health</h4>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-info">
                            ...
                            <h4 className="text-xs font-black uppercase tracking-[0.2em]">Consensus Reach</h4>
                        </div>
                        <div className="space-y-1">
                            <p className="text-2xl font-black text-zinc-text tabular-nums tracking-tighter leading-none">84.2%</p>
                            <p className="text-[10px] text-zinc-muted font-bold uppercase">Peak Participation Probability</p>
                        </div>
                    </div>
