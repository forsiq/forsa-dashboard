      ...
      <div className="space-y-6">
        ...
        {listLoading ? (
          ...
          <Card className="!p-24 text-center space-y-6 bg-obsidian-card/40 border-dashed border-border/40">
             ...
             <AmberButton onClick={() => navigate('/group-buying/new')} className="h-12 px-10 rounded-xl bg-brand text-black font-black uppercase active:scale-95 transition-all shadow-lg">
