...
import { formatChangelogDate } from '../utils/formatChangelogDate';
import type { ChangelogRelease, ChangeType, LocalizedText } from '../types';
...
export const ChangelogCard: React.FC<ChangelogCardProps> = ({
  ...
  const isNew = daysSinceRelease < newDurationDays;
