...
const defaultActions: QuickActionType[] = [
  { id: '1', label: 'New Item', icon: <Plus className="w-4 h-4" />, path: '/new', color: 'brand' },
  { id: '2', label: 'Analytics', icon: <BarChart className="w-4 h-4" />, path: '/analytics', color: 'info' },
  { id: '3', label: 'Users', icon: <Users className="w-4 h-4" />, path: '/users', color: 'success' },
  { id: '4', label: 'Settings', icon: <Settings className="w-4 h-4" />, path: '/settings', color: 'warning' }
];
