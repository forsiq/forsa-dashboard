    ...
    return (
        <div className="max-w-5xl mx-auto space-y-12 py-10 animate-in fade-in duration-700 px-4 relative" dir={dir}>
            ...
            <div className={cn("absolute top-4 z-20", dir === 'rtl' ? 'right-4' : 'left-4')}>
                <Link to="/" className="flex items-center gap-2 text-[10px] font-black text-zinc-muted hover:text-zinc-text uppercase tracking-widest transition-colors bg-obsidian-card/80 backdrop-blur-sm px-3 py-1.5 rounded-full border border-border hover:border-brand/20">
