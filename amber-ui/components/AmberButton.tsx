...
export const AmberButton: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: 'bg-brand text-slate-900 hover:bg-brand/90 shadow-sm',
    secondary: 'bg-white/5 border border-white/10 text-zinc-text hover:bg-white/10',
    ghost: 'bg-transparent text-zinc-muted hover:text-zinc-text hover:bg-white/5',
